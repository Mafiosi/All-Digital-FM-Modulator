...
xst -ifn xst.scr
move clockdiv2_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clockdiv2_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clockdiv2_exdes.ucf clockdiv2_exdes

echo 'Running map'
map -timing -pr b clockdiv2_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clockdiv2_exdes -w routed.ncd routed.v
cd ..
